...
class Jupiter_CLI(Wallet):
    ...
    async def token_sniper_menu(self):
        """CLI - TOKEN SNIPER MENU."""
        f.display_logo()
        print("[CLI] [TOKEN SNIPER MENU]")
        print()
...
class Main_CLI():
    ...
    async def first_login():
        ...
        f.display_logo()
        print("Welcome to the Python CLI v.0.0.1! Made by @m1nfpsz")
    ...
    async def main_menu():
        ...
        match cli_prompt_main_menu:
            ...
            case "About":
                ...
                print("DESCRIPTION")
                description = (
                    "This tool is a commande-line interface to use Exchange faster made by @m1nfpsz." + 
                ...
                contributions = (
                    ...
                    "\nDiscord: m1nfpss | Twitter: @m1nfpsz | Github: m1nfpsz0"
                )
